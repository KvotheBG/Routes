...
<div class="container single-panel">
	<div class="container">
        ...
        <div class="row">
	        ...
	        <div class="mar-bott col-lg-4 col-md-8 col-sm-8 col-10 offset-lg-4 offset-md-2 offset-sm-2 offset-1">
	        	<div class="bg-dark map-result-panel text-white">
	        		<h3 style="padding: 15px 0 40px 0;" class="text-center">Cities</h3>
